phrases = {
    ...
    "start_message": "Hello! I am CleoverBot, I will help you get the latest and most useful information from the world of cryptocurrencies!",
    ...
    "create_payment_text": "🧾 Your subscription invoice:\n\n",
